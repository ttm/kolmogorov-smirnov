...
\FloatBarrier
\section{Conclusions and automation of the benchmarks}\label{sec:conc}
...
the setting of
$N_c=100$ comparisons per measure,
$n=n'=1000$ elements in each sample,
$N_b=30$ equally spaced bins was settled
as the template of this document.
