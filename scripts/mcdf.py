...
p.plot(base1[:-1], n1__/200000, "k-.^", linewidth=5,alpha=.7,label=r"$F$")
#p.plot(base1[:-1], n1__/200000, c="k", linewidth=2,alpha=.7,label=r"$F_n$")
p.plot(base2[:-1], n2__/200000, "k-o",linewidth=5 ,alpha=.7,label=r"$F'$")
...
p.text(mx-12,(my1+my2)/2,r"$D_{F,F'}$",fontsize=25)


p.plot((mx_+1.5,mx),(my1,my1),"k-.",linewidth=1)
p.plot((mx_+1.5,mx),(my2,my2),"k-.",linewidth=1)
p.ylabel(r"$F\;,\;F'$",fontsize=15)
p.xlabel(r"$X$",fontsize=15)
